...
public class E2E_Test {
	...
	public static void main(String[] args) throws InterruptedException {
		System.setProperty("webdriver.chrome.driver","C:/Users/aravinda_dv/workspace/CucumberFramework/src/test/resources/chromedriver.exe");
		...
		Thread.sleep(5000);
		WebElement firstName = driver.findElement(By.xpath("//*[@id=\"billing_first_name\"]"));//cssSelector("#billing_first_name"));
